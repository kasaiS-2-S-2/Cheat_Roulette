...
public class RouletteView extends View {
    ...
    private Paint colorPaint, startButtonPaint, startButtonBelowPaint, firstColorPaint, edgePaint, shadowPaint;
    private Paint textPaint;
    private float angle;
    private int num;
    public int sumOfItemRatio = 0;
    private int angleCount = 0;
    private float sumOfAngle = 0;
    private float pos = 0;
    private boolean isStateNoRoulette = true;
