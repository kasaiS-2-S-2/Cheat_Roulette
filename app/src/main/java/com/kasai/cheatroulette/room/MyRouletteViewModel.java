...
public class MyRouletteViewModel extends AndroidViewModel {
    ...
    public LiveData<List<MyRoulette>> getAllMyRoulette() {
        return mAllMyRoulette;
    }

    public MyRoulette getMyRoulette(int id) {
        return mRepository.getMyRoulette(id);
    }

    public void insert(MyRoulette myRoulette) {
        mRepository.insert(myRoulette);
    }

    public void update(MyRoulette myRoulette) { mRepository.update(myRoulette); }
