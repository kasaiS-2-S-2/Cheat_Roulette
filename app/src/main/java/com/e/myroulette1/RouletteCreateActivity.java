 ...
 */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editText = findViewById(R.id.rouletteName);
        ...
        if (fromMainIntent.getAction() != null && fromMainIntent.getAction().equals("EDIT_ROULETTE")) {
            ...
            rouletteItemListInfo.setColors(colors);
            rouletteItemListInfo.setItemNames(itemNames);
            rouletteItemListInfo.setItemRatios(itemRatios);
            rouletteItemListInfo.setOnOffInfoOfSwitch100(OnOffInfoOfSwitch100Boolean);
            rouletteItemListInfo.setOnOffInfoOfSwitch0(OnOffInfoOfSwitch0Boolean);
